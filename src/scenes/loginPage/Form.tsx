...
type AllValuesType = typeof initialValuesLogin | typeof initialValuesRegister;

const Form: React.FC<AllValuesType> = ({password, email}) => {
    ...
    const initialValues: AllValuesType = {
        email: '',
        password: '',
        location: '',
        occupation: '',
